...
it('unmounts closed chat controls, focuses the input and restores launcher focus on close and Escape', () => {
  ...
  expect(screen.getByText(/indexed repository metadata and README evidence/)).toBeInTheDocument()
  expect(screen.getByRole('region', { name: 'Proofstack_Chat' })).toHaveClass('fixed')
